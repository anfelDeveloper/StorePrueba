...
function Header() {
  return (
    <header className="w-full flex items-center justify-between p-4 bg-gradient-to-r from-blue-500 to-teal-500 shadow-lg">
      ...
      <div className="hidden md:flex flex-col items-center text-white mx-4">
        <p className="text-base mt-1">Estilo y elegancia al alcance de tu mano</p>
      </div>
      ...
      <div className="flex items-center space-x-4 text-white">
        ...
        <ShoppingCartIcon className="w-8 h-8 text-white hover:text-gray-200 transition-colors duration-300" />
      </div>
    </header>
  );
}
